...
export default function Success() {
  ...
  const redirectStatus = params?.get("status"); // Flutterwave sends this
    ...
    (async () => {
      try {
        ...
        if (axios.isAxiosError(err)) {
          ...
          message = axiosErr.response?.data?.error || "verification_failed";
        } else if (err instanceof Error) {
          message = err.message || "verification_failed";
